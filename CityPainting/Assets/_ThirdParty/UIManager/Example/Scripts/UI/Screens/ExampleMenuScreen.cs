...
public class ExampleMenuScreen : ScreenUI
{
    ...
    {
        var screenData = new ScreenUI.Data();
        screenData.Add("message", message);

        //UIManager.Instance.QueuePush(ScreenIds.ExamplePopup);
        // UIManager.Instance.QueuePush(ScreenIds.ExamplePopup, screenData);
        //UIManager.Instance.QueuePush(ScreenIds.ExamplePopup, screenData, "Screen_ExamplePopup", null);
    }
}
